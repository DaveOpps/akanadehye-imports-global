...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/sourcing", label: "Sourcing", icon: "globe" },
    ],
  },
  {
    label: "Get paid",
    items: [
      ...
      { href: "/admin/invoices", label: "Invoices", icon: "send" },
    ],
  },
  {
    label: "Engage",
    items: [
      { href: "/admin/chatbots", label: "Chatbots", icon: "chat" },
      { href: "/admin/chatbots/whatsapp", label: "WhatsApp", icon: "whatsapp" },
      { href: "/admin/chatbots/telegram", label: "Telegram", icon: "telegram" },
      { href: "/admin/chatbots/persona", label: "Persona", icon: "persona" },
      { href: "/admin/chatbots/test", label: "Test chat", icon: "play" },
    ],
  },
  {
    label: "Finance",
    items: [
      { href: "/admin/finance", label: "Finance Hub", icon: "finance" },
    ],
  },
  {
    label: "Grow",
...
export default function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  function isActive(href: string) {
    ...
    // The Chatbots overview link shouldn't stay active when you're on a sub-page
    ...
    <div className="max-w-7xl mx-auto px-5 lg:px-8 py-8 lg:py-10">
      <div className="grid gap-8 lg:grid-cols-[240px_1fr]">
        <aside className="lg:sticky lg:top-20 lg:self-start">
          ...
          <p className="mt-3 text-xs text-[color:var(--muted)] px-2 leading-relaxed">
            Demo data is stored locally in your browser. Clear browser storage to reset.
          </p>
        </aside>
